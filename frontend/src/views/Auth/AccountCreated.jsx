    ...
    <>
      <div className="w-full px-[1rem]">
        <div className="grid grid-cols-12 grid-rows-1">
          <div
            className="hidden md:block md:col-span-6 w-full h-screen bg-cover bg-center"
            style={{ backgroundImage: `url(${imageCreated})` }}
          >
            <div className="w-full h-full flex items-start justify-center pt-40">
              <h2 className="text-white font-light texter justify-center text-[1.5rem] text-center">
                Permite <span className="font-bold">mitigar</span> los{" "}
                <span className="font-bold">Gastos</span>que implican los
                vehiculos
              </h2>
            </div>
          </div>
            ...
            <div className="text-center shadow-md py-6 px-7">
              {isLoading ? (
                ...
                <>
                  ...
                  <p className="text-center font-thin font text-lg mb-9">
                    ¡Te enviamos un Email!
                  </p>
                  <p className="mb-10">
                    Debes activar tu cuenta con el link que enviamos a tu correo
                  </p>
