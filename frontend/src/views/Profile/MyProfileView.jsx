...
function MyProfileView() {
  ...
  const [modalShowPic, setModalShowPic] = useState(false);
    ...
    <>
      ...
      <div className="profile-container flex max-sm:flex-col overflow-x-hidden items-start justify-center">
        ...
        >
          ...
          <div
            style={{ borderBottom: "0.09px solid gray", marginBottom: "15px" }}
          ...
          >
            <div
              ...
              className="myprofile-data relative pt-2 rounded-lg"
            >
              <img
                style={{ borderRadius: "50%", border: "2px solid #3BED1E " }}
                src={
              ...
              <span style={{ fontSize: "30px" }}>
                <strong>{`${currentUser.name} ${currentUser.lastName}`}</strong>
              </span>
              <img
                onClick={() => setModalShowPic(true)}
                style={{
                  position: "absolute",
                  top: "10px",
                  left: "70%",
            ...
            <div
              style={{ margin: "none", borderTop: "0.09px solid gray" }}
              className="userdata-container relative flex-col mt-3"
            >
